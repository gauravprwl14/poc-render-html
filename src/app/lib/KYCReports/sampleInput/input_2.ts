          ...
          formatResponse([
            {
              ...
              id: "ver_oWFL9XqWWuXHSyF31hYXGwTkJwX8",
              attributes: {
                status: "failed",
                created_at: "2024-11-12T13:27:35.000Z",
                created_at_ts: 1731418055,
                submitted_at: "2024-11-12T13:27:35.000Z",
                submitted_at_ts: 1731418055,
                completed_at: "2024-11-12T13:27:36.000Z",
                completed_at_ts: 1731418056,
                country_code: "EG",
                name_first: "Abdullah",
                name_middle: null,
                name_last: "Ahmed Abdullah",
                address_street_1: "620 Iris Ave",
                address_street_2: "Sunnyvale, CA 94095",
                address_city: "Sunnyvale",
                address_subdivision: "California",
                address_postal_code: "94086",
                birthdate: "1982-07-15",
                email_address: "terryowens430@gmail.com",
                phone_number: "18479205690",
                checks: [
                  {
              ...
              relationships: {
                ...
                transaction: {
                  data: {
                    type: "transaction",
                    id: "txn_ZHE8VfbUy1LyGB4iH9KeL6HtARHp",
                  },
                },
              },
            },
          ...
          formatResponse([
            {
              ...
              id: "rep_vnVUKxYfJXMErGPZ7e2KLoekvPzJ",
              attributes: {
                status: "ready",
                created_at: "2024-11-12T13:32:38.000Z",
                completed_at: "2024-11-12T13:32:41.000Z",
                redacted_at: null,
                report_template_version_name: "v2",
                has_match: true,
                is_continuous: false,
                is_recurring: false,
                tags: [],
                ...
                name_middle: null,
                name_last: "bin Laden",
                term: "Osama bin Laden",
                birthdate_year: 1957,
                birthdate: "1957-03-10",
                country_code: "SA",
                related_sources: [
                  {
                    akas: ["al Qaeda Osama bin Laden"],
                    birthdates: [],
                    ...
                    media: [
                      {
                        date: "2016-12-17",
                        snippet:
                          "Osama bin Laden's son Omar Bin Laden denied entry to Egypt, deported Security officials at Cairo International Airport say Omar bin Laden, son of the former leader of al-Qaeda Osama bin Laden, has been denied entry to the country and was deported to Turkey. Omar bin Laden during an interview with the Associated Press in Cairo, Egypt in 2008.",
                        url: "http://www.news.com.au/travel/travel-updates/incidents/egypt-denies-osama-bin-ladens-son-omar-bin-laden-entry/news-story/bf673dc31cb714bd6c11945260f9c659",
                        title:
                          "Osama bin Laden's son Omar Bin Laden denied entry to Egypt, deported",
                      },
                    ],
                    name: "al Qaeda Osama bin Laden",
                    sources: [
                      {
                        country_codes: [],
                        name: "Adverse Media",
          ...
          formatResponse([
            {
              ...
              id: "rep_2pXAu6iXJCWZniGFaMr4nid2XBoF",
              attributes: {
                status: "ready",
                created_at: "2024-11-12T13:32:25.000Z",
                completed_at: "2024-11-12T13:32:25.000Z",
                redacted_at: null,
                ...
                matched_lists: [
                  {
                    name: "EU - EC - Programme TAQA - Al Qaeda",
                    url: "http://eur-lex.europa.eu/LexUriServ/LexUriServ.do?uri=OJ:L:2013:172:0001:0003:EN:PDF",
                    list_type: "sanction",
                    list_types: ["sanction"],
                    slug: "eu-ec-programme-taqa",
                    flag_code: "EU",
                    entities: [
                      {
                        name: "Abu Abdallah Abd Al-Hakim",
                      ...
                      {
                        name: "Bin Laden Osama Mohamed Awdh",
                        alias_type: "primary_name",
                        birthdates: [
                          {
                            day: "01",
                      ...
                      {
                        name: "Bin Laden Usamah Bin Muhammad",
                        alias_type: "primary_name",
                        birthdates: [
                          {
                            day: "01",
                      ...
                      {
                        name: "Osama bin Muhammad bin Awad bin Ladin",
                        alias_type: "primary_name",
                        birthdates: [
                          {
                            day: "01",
                      ...
                      {
                        name: "Usama  Bin  Muhammed  Bin  Awad,  Osama  Bin  Laden",
                        alias_type: "primary_name",
                        birthdates: [
                          {
                            day: "01",
                      ...
                      {
                        name: "Usama Muhammed Awad Bin Laden",
                        alias_type: "primary_name",
                        birthdates: [
                          {
                            day: "01",
                      ...
                      {
                        name: "Usamah Bin Muhammad Bin Ladin",
                        alias_type: "primary_name",
                        birthdates: [
                          {
                            day: "01",
                    ...
                    entities: [
                      {
                        name: "Usama Muhammed Awad BIN LADEN",
                        alias_type: "primary_name",
                        birthdates: [{ year: "1957", granularity: "year" }],
                      },
                      {
                        name: "Al Qaqa",
                        alias_type: "aka",
                  ...
                  },
                  {
                    ...
                    entities: [
                      {
                        name: "BIN LADIN, Usama bin Muhammad bin Awad",
                        alias_type: "primary_name",
                        birthdates: [
                          {
                            day: "30",
                      ...
                      {
                        name: "BIN LADIN, Osama bin Muhammad bin Awad",
                        alias_type: "aka",
                        birthdates: [
                          {
                            day: "30",
                  ...
                  {
                    name: "KR - Financial Intelligence Unit (FIU, KoFIU) - Restricted Persons in Financial Transactions",
                    url: "https://www.kofiu.go.kr/eng/regime/cftRegime.do",
                    list_type: "sanction",
                    list_types: ["sanction"],
                    slug: "kr-kofiu-restricted-persons-in-financial-transactions",
                    flag_code: "KR",
                    entities: [
                      {
                        name: "Usama bin Laden",
                      ...
                      { name: "AL QA'IDA", alias_type: "aka", birthdates: [] },
                      { name: "AL QAEDA", alias_type: "aka", birthdates: [] },
                      { name: "AL-JIHAD", alias_type: "aka", birthdates: [] },
                      {
                        name: "EGYPTIAN AL-JIHAD",
                        alias_type: "aka",
                        birthdates: [],
                      },
                      {
                      ...
                      {
                        name: "INTERNATIONAL FRONT FOR FIGHTING JEWS AND CRUSADES",
                        alias_type: "aka",
                        birthdates: [],
                      },
                      {
                      ...
                      {
                        name: "ISLAMIC ARMY FOR THE LIBERATION OF HOLY SITES",
                        alias_type: "aka",
                        birthdates: [],
                      },
                      {
                        name: "ISLAMIC SALVATION FOUNDATION",
                        alias_type: "aka",
                        birthdates: [],
                      },
                      { name: "NEW JIHAD", alias_type: "aka", birthdates: [] },
                      { name: "THE BASE", alias_type: "aka", birthdates: [] },
                      {
                        name: "THE GROUP FOR THE PRESERVATION OF THE HOLY SITES",
                        alias_type: "aka",
                        birthdates: [],
                      },
                      {
                        name: "THE ISLAMIC ARMY FOR THE LIBERATION OF THE HOLY PLACES",
                        alias_type: "aka",
                        birthdates: [],
                      },
                      {
                        name: "THE JIHAD GROUP",
                        alias_type: "aka",
                        birthdates: [],
                      },
                      {
                        name: "THE WORLD ISLAMIC FRONT FOR JIHAD AGAINST JEWS AND CRUSADERS",
                        alias_type: "aka",
                        birthdates: [],
                      },
                      {
                        name: "USAMA BIN LADEN NETWORK",
                        alias_type: "aka",
                        birthdates: [],
                      },
                      {
                        name: "USAMA BIN LADEN ORGANIZATION",
                        alias_type: "aka",
                        birthdates: [],
                      },
                    ],
                ...
                run_history: [
                  {
                    scheduled_at: "2024-11-12T13:32:25.000Z",
                    completed_at: "2024-11-12T13:32:25.000Z",
          ...
          formatResponse([
            {
              ...
              id: "rep_HrXv1qEhycV7pBuFbiLCZ3cyrsYB",
              attributes: {
                status: "ready",
                created_at: "2024-11-12T13:32:13.000Z",
                completed_at: "2024-11-12T13:32:13.000Z",
                redacted_at: null,
                report_template_version_name: "v5",
                has_match: true,
                is_continuous: false,
                ...
                result: [
                  {
                    ...
                    aliases: [
                      ...
                      "Usama BIN LADIN",
                      "Usama Bin Ladin",
                      "Usama Bin Muhammed Bin Awad / Osama Bin Laden / Abu Abdallah Abd Al-Hakim",
                      "Usama Bin Muhammed Bin Awad Osama Bin Laden",
                    ...
                    positions: [],
                    associates: [
                      { name: "Hamida al-Attas", relationship: "Mother" },
                      { name: "Siham Sabar", relationship: "Spouse" },
                      { name: "Khairiah Sabar", relationship: "Spouse" },
                      { name: "Tarek bin Laden", relationship: "Sibling" },
                      { name: "Bakr Bin Laden", relationship: "Sibling" },
                      { name: "Sumaiya bin Laden", relationship: "Child" },
                      { name: "Miriam bin Laden", relationship: "Child" },
                      {
                        name: "Hamza Usama Muhammad Bin Laden",
                        relationship: "Father",
                      },
                      { name: "Najwa bin Laden", relationship: "Spouse" },
                      { name: "Yeslam bin Ladin", relationship: "Sibling" },
                      { name: "Abdallah bin Laden", relationship: "Child" },
                      {
                        name: "Hamza Usama Muhammad Bin Laden",
                        relationship: "Child",
                      },
                      { name: "Omar bin Laden", relationship: "Child" },
                      { name: "Saad bin Laden", relationship: "Child" },
                      { name: "Khalid bin Laden", relationship: "Child" },
                      { name: "Amal Ahmed al-Sadah", relationship: "Spouse" },
                    ],
                    affiliations: [],
                    related_urls: [
                      {
                        source_key: "internal-source-url",
                        name: "https://gels-avoirs.dgtresor.gouv.fr/Gels/RegistreDetail?idRegistre=2901",
                      },
                      {
                        source_key: "internal-source-url",
                        name: "https://sanctionssearch.ofac.treas.gov/Details.aspx?id=6365",
                      },
                    ],
                    images: [],
                    sources: {
                      wikidata: {
                        url: "https://www.wikidata.org/wiki/Q1317",
                        name: "Wikidata",
                        flag_code: null,
                      },
                      internal_data_source: {
                        url: "https://www.dans.bg/images/stories/FID/Reshenie_265_MS_23042003_Spisyk_ZMFT.pdf",
                    ...
                    match_types: ["name_exact"],
                    pep_type: "relative_close_associate",
                  },
                ],
                run_history: [
                  {
                    scheduled_at: "2024-11-12T13:32:13.000Z",
                    completed_at: "2024-11-12T13:32:13.000Z",
          ...
          formatResponse([
            {
              ...
              id: "rep_f4HpfECJmmRaLVAsLYdq5T8xUTd3",
              attributes: {
                status: "ready",
                created_at: "2024-11-12T13:31:59.000Z",
                completed_at: "2024-11-12T13:31:59.000Z",
                redacted_at: null,
                ...
                tags: [],
                addressee: null,
                address_street_1: "Waziristan Haveli",
                address_street_2: null,
                address_city: "Abbottabad",
                address_subdivision: "Khyber Pakhtunkhwa",
                address_postal_code: "22010",
                resolved_addressee: null,
                resolved_address_street_1: null,
                resolved_address_street_2: null,
                resolved_address_city: null,
                resolved_address_subdivision: null,
                resolved_address_postal_code: null,
                metadata_record_type: null,
                metadata_zip_type: null,
                metadata_county_fips: null,
                metadata_county_name: null,
                metadata_carrier_route: null,
                metadata_carrier_route_type: null,
                metadata_congressional_district: null,
                metadata_building_default_indicator: null,
                metadata_residential_delivery_indicator: null,
                metadata_latitude: null,
                metadata_longitude: null,
                metadata_precision: null,
                metadata_time_zone: null,
                metadata_utc_offset: null,
                metadata_obeys_daylight_savings: null,
                analysis_dpv_match_code: null,
                analysis_dpv_match_code_decoded: null,
                analysis_dpv_footnotes: null,
                analysis_dpv_footnotes_decoded: null,
                analysis_dpv_cmra: null,
                analysis_dpv_vacant: null,
          ...
          formatResponse([
            {
              ...
              id: "rep_YDdvk4m7dSC1SZ3immzoqxfxy1mx",
              attributes: {
                status: "ready",
                created_at: "2024-11-12T13:17:45.000Z",
                completed_at: "2024-11-12T13:17:45.000Z",
                redacted_at: null,
                report_template_version_name: "v1",
                has_match: true,
                is_continuous: false,
                ...
                phone_number: "18479205690",
                phone_type: "VOIP",
                phone_carrier: "Comcast",
                phone_risk_level: "medium",
                phone_risk_recommendation: "flag",
                phone_risk_score: 500,
