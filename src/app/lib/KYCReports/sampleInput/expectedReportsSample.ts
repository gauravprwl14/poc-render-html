          ...
          checks: {
            governmentIdCheck: {
              government_id_verification: {
                status: "success",
                vendor: "xyz",
                // This is a placeholder for the actual data corresponding to the Government ID verification
                data: {
                  type: "verification/government-id",
                  id: "ver_ZTTgPabR2RX1ffn3BsVJ8oLouXJG",
                  display: {
                    summary: "<p>Government ID verification passed</p>",
                    detailed: "<p>Government ID verification passed</p>",
                  },
                  attributes: {
                    status: "passed",
